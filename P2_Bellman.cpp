...
int main()
{
    ...
    std::cout << "3. Wczytaj graf z pliku z zupelnie innymi paramterami jako lista sasiedztwa: " << std::endl;
    std::cout << "4. Wczytaj graf z pliku z zupelnie innymi paramterami jako macierz sasiedztwa: " << std::endl;
